...
class Robot:
    ...
    def load_from_json(self, analytical_derivatives):
        ...
        with open(str(get_project_root()) + "/models/robots/" + self.name + ".json", "r") as f:
        ...
        self.fd = Function.load(str(get_project_root()) + "/" + str(json_dict["forward_dynamics_path"]))
        self.id = Function.load(str(get_project_root()) + "/" + str(json_dict["inverse_dynamics_path"]))
        self.fk = Function.load(str(get_project_root()) + "/" + str(json_dict["forward_kinematics_path"]))

        self.J_fd = Function.load(str(get_project_root()) + "/" + str(json_dict["Jacobian_forward_dynamics_path"]))
        self.J_id = Function.load(str(get_project_root()) + "/" + str(json_dict["Jacobian_inverse_dynamics_path"]))
