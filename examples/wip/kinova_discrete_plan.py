...
if __name__ == '__main__':
    ...
    # --------------------------------------------------------------------------
    tc = tp.TaskContext(horizon_size*t_mpc)
...
# --------------------------------------------------------------------------------
    approach = tp.Point2Point(horizon_size*t_mpc)

    robot.set_state(q0_val + q_dot0_val)
    approach.add_robot(robot)
    q, q_dot, q_ddot, q0, q_dot0 = robot.set_input_resolution(approach,"acceleration")
...
# --------------------------------------------------------------------------------
    ...
    #
    # tc_pickup = tp.TaskContext(horizon_size_pickup*t_mpc)
    #
    # q_pickup, q_dot_pickup, q_ddot_pickup, q0_pickup, q_dot0_pickup = robot.set_input_resolution(tc_pickup,"acceleration")
    #
    # #computing the expression for the final frame
    # print(robot.fk)
