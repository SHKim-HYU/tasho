...
if __name__ == "__main__":
    ...
    if visualizationBullet:
        ...
        cylID = p.loadURDF(
            "cube_small.urdf", [0.5, 0, 0.25], [0.0, 0.0, 0.0, 1.0], globalScaling=3.0
        )
        ...
        obj.setController(
            kukaID, "velocity", joint_indices, targetVelocities=q_dot_sol[0]
        )
        ...
        obj.setController(
            kukaID, "velocity", joint_indices, targetVelocities=q_dot_sol[-1]
        )
        ...
        cylID2 = p.loadURDF(
            "cube_small.urdf", [0.6, 0, 0.25], [0.0, 0.0, 0.0, 1.0], globalScaling=2.0
        )
        cylID3 = p.loadURDF(
            "cube_small.urdf", [0.4, 0, 0.25], [0.0, 0.0, 0.0, 1.0], globalScaling=2.0
        )
        cylID4 = p.loadURDF(
            "cube_small.urdf", [0.6, 0, 0.25], [0.0, 0.0, 0.0, 1.0], globalScaling=2.0
        )
        cylID5 = p.loadURDF(
            "cube_small.urdf", [0.6, 0.1, 0.25], [0.0, 0.0, 0.0, 1.0], globalScaling=2.0
        )
        cylID6 = p.loadURDF(
            "cube_small.urdf", [0.6, 0, 0.25], [0.0, 0.0, 0.0, 1.0], globalScaling=2.0
        )
