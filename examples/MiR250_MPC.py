...
x_init = Variable.Variable(robot.name, 'x_init', 'parameter', (3,1))
v_init = Variable.Variable(robot.name, 'v_init', 'parameter', (2,1))
goal_pose = Variable.Variable(robot.name, "goal_pose", 'parameter', (3,1))

task_P2P = P2P(robot, 3, goal_pose, x_init, 0.001)
