...
pathpoints = 300
ref_path = {}
ref_path['x'] = 2*np.sin(np.linspace(0,4*np.pi, pathpoints+1))
...
# Create a list of N waypoints
current_waypoints = get_current_waypoints(index_closest_point, wp, horizon_samples, dist=0.05)
